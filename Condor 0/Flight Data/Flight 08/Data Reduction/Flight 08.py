...
# Read the log file
log_path = os.path.join(os.path.dirname(__file__), "..\\Onboard\\00000017.log")
...
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Z_Acceleration_Full.png", dpi=300, bbox_inches='tight')  # Save the plot as a PNG file
...
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Z_Acceleration_Takeoff.png", dpi=300, bbox_inches='tight')  # Save the zoomed-in plot as a PNG file
plt.close()
...
plt.title("Condor 0 Flight 08 Groundspeed")
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\groundspeed_full.png", dpi=300, bbox_inches='tight')  # Save the plot
plt.close()
...
plt.title("Condor 0 Flight 08 Roll Deviation")
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Roll Dev.png", dpi=300, bbox_inches='tight')  # Save the plot
plt.close()
...
plt.title("Condor 0 Flight 08 Pitch Deviation")
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Pitch Dev.png", dpi=300, bbox_inches='tight')  # Save the plot
plt.close()
...
plt.title("Condor 0 Flight 08 \u03b1/\u03b2")
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\AlphaBeta.png", dpi=300, bbox_inches='tight')  # Save the plot
plt.close()
...
plt.title("Condor 0 Flight 08 Airspeed")
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Airspeed_Full.png", dpi=300, bbox_inches='tight')  # Save the plot
plt.close()

CTUN_Landing = dataframes["CTUN"][(dataframes["CTUN"]["timestamp"] >= 760) & (dataframes["CTUN"]["timestamp"] <= 780)]
XKF1_Landing = dataframes["XKF1"][(dataframes["XKF1"]["timestamp"] >= 760) & (dataframes["XKF1"]["timestamp"] <= 780)]
AOA_Landing = dataframes["AOA"][(dataframes["AOA"]["timestamp"] >= 760) & (dataframes["AOA"]["timestamp"] <= 780)]
plt.figure(figsize=(16, 9))
...
plt.xlabel("Time Since Power On (s)")
# plt.ylabel("Airspeed (m/s)")
plt.title("Condor 0 Flight 08 Airspeed (Landing)")
plt.legend()
plt.savefig("Condor 0\\Flight Data\\Flight 08\\Data Reduction\\Landing.png", dpi=300, bbox_inches='tight')  # Save the plot
